...
#[derive(Debug)]
pub struct PolygonMintProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PolygonMintProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PolygonMint processing");
    
    let mut processor = PolygonMintProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PolygonMintProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PolygonMintProcessor::new(false);
